...
- [escalated to user] promote partition: round 1 voted 0/3 and round 2 1/3, both on traceability rather than substance — three items were unverifiable because they had never been written down. Record corrected both rounds; the surviving objection was a wrong commit citation in the hook-lint entry, which I withdrew. User chose to keep that entry marked as testimony.
- [skipped — small] TODO disposition: every TODO has one unambiguous home (evidence: all five are deferred verification or refactor tasks, none is new feature work, so all go to `followups.md`; no new-proposal seeds, single file touched, no public interface)
